...
$view=$pdo->prepare("SELECT * FROM tbl_ticket where accepted='yes'");
$view->execute();
?>
<!DOCTYPE html>
<html>
      ...
      <div class="container bg-light p-3" style="border-radius: 10px;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><SPAN><a onclick="return confirm('Are you sure to delete?')" href="delete_ticket.php?id=<?=$display['id']?>">delete</SPAN></a></td>
