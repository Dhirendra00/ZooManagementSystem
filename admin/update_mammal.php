...
$stmt=$pdo->prepare("UPDATE tbl_mammal SET species_name=:species_name,given_name=:given_name,category=:category,av_life_span=:av_life_span,date_of_birth=:date_of_birth,date_joined=:date_joined,dietry_requirement=:dietry_requirement,natural_habitat=:natural_habitat,location_code=:location_code,dimension_in_zoo=:dimension_in_zoo,average_dimension=:average_dimension,gestational_period=:gestational_period,gender=:gender,image=:image where id=:id");
$criteria =[
