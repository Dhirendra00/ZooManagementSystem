...
$stmt=$pdo->prepare("INSERT INTO tbl_sponsor(company_name,existing_customer,contact_number,telephone_number,address,animal_name,location,sponsorship_band,total_price,period_of_agreement,signage,signage_displayed,special_note,customer_agreement,payment_detail,payment_received,sponsorship_review_date,signed) VALUES (:company_name,:existing_customer,:contact_number,:telephone_number,:address,:animal_name,:location,:sponsorship_band,:total_price,:period_of_agreement,:signage,:signage_displayed,:special_note,:customer_agreement,:payment_detail,:payment_received,:sponsorship_review_date,:signed)");
$criteria =[
...
if($stmt->execute($criteria)){
    ?>
     <strong>Added successfully.Pree Ok!! <button> <a href="admin_sponsor.php">OK</a></button></strong>
     <?php
}
else{
  echo "error";
...
<!-- <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 " style="background-color: rgb(23,22,22); opacity: 0.5; border-radius: 5rem;"  > -->
          ...
          <div class="row">
            <h1 class="text-danger text-center ml-3 ">Add Sponsor</h1> <a href="admin_sponsor.php"><button class="btn btn-outline-danger my-3 my-sm-0 text-capitalize" style="background-color: rgb(50,187,179); width: 10rem; font-size: 20px; font-weight: bold; margin-left: 37rem;" type="submit">Back</button></a> <br>
...
<!-- third row -->
 ...
 <!-- fifth row -->
  ...
  <div class="form-group row p-2">
    <div class="col-sm-6">
      <button type="submit" name="add_sponsor" class="btn" style="background-color: rgb(50,187,179); font-size: 20px; font-weight: bold; ">Confirm</button>
