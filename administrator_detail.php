  ...
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link text-capitalize ml-3 h5" href="administrator.php">Administrator  <span class="sr-only">(current)</span></a>
      </li>
...
<!-- <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 " style="background-color: rgb(23,22,22); opacity: 0.5; border-radius: 5rem;"  > -->
          ...
          <div class="row">
            <a href="administrator.php"><button class="btn btn-outline-danger ml-3 my-sm-0 text-capitalize" style="background-color: rgb(50,187,179); width: 10rem; font-size: 20px; font-weight: bold;" type="submit">Back</button></a> <br>
      ...
      <div class="form-row">
        ...
        if (isset($_GET['id'])) {
  $id=$_GET['id'];
$view=$pdo->prepare("SELECT * FROM tbl_administrator WHERE id={$_GET['id']}");
$view->execute();
    ...
    <label> <?php
          echo '<img src="admin/photo/administrator/'.$display['image'].'" width="150rem"; height="150rem"; alt=" card image cap">';?></label>
  
  </div>
    <div class="form-group col-md-6">
      <label>First Name : <?php echo $display['first_name']; ?></label>
    
    </div>
    <div class="form-group col-md-6">
      <label>Last Name : <?php echo $display['last_name']; ?></label>
    </div>
     
     <div class="form-group col-md-6">
      <label>Contact : <?php echo $display['contact']; ?></label>
...
<!-- second row -->
  <div class="form-group col-md-6">
    ...
    <div class="form-group col-md-6">
      <label>Email : <?php echo $display['email']; ?></label>
     
    </div>
     <div class="form-group col-md-6">
      <label>Bio : <?php echo $display['bio']; ?></label>
