...
<!-- <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 " style="background-color: rgb(23,22,22); opacity: 0.5; border-radius: 5rem;"  > -->
          ...
          <div class="row">
            <a href="sponsor.php"><button class="btn btn-outline-danger ml-3 my-sm-0 text-capitalize" style="background-color: rgb(50,187,179); width: 10rem; font-size: 20px; font-weight: bold;" type="submit">Back</button></a> <br>
      ...
      <div class="form-row">
        ...
        if (isset($_GET['id'])) {
  $id=$_GET['id'];
$view=$pdo->prepare("SELECT * FROM tbl_sponsor WHERE id={$_GET['id']}");
$view->execute();
    ...
    <label> <?php
          echo '<img src="admin/photo/sponsor/'.$display['signage_displayed'].'" width="150rem"; height="150rem"; alt=" card image cap">';?></label>
  
  </div>
    <div class="form-group col-md-6">
      <label>Company Name : <?php echo $display['company_name']; ?></label>
    
    </div>
    <div class="form-group col-md-6">
      <label>Existing Customer : <?php echo $display['existing_customer']; ?></label>
    </div>
     
     <div class="form-group col-md-6">
      <label>Contact Number : <?php echo $display['contact_number']; ?></label>
    
    </div>
<!-- second row -->
  <div class="form-group col-md-6">
      <label>Telephone Number : <?php echo $display['telephone_number']; ?></label>
    
    </div>
    <div class="form-group col-md-6">
      <label>Address : <?php echo $display['address']; ?></label>
     
    </div>
     <div class="form-group col-md-6">
      <label>Animal Name : <?php echo $display['animal_name']; ?></label>
     
    </div>

<!-- third row -->
  <div class="form-group col-md-6">
      <label>Location : <?php echo $display['location']; ?></label>
     
    </div>
    <div class="form-group col-md-6">
      <label>Signange : <?php echo $display['signage']; ?></label>
    
    </div>
     <div class="form-group col-md-6">
      <label>Sponsorship Band : <?php echo $display['sponsorship_band']; ?></label>
