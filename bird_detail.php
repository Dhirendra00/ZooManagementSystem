...
<!-- <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 " style="background-color: rgb(23,22,22); opacity: 0.5; border-radius: 5rem;"  > -->
      ...
      <div class="form-row">
        ...
        if (isset($_GET['id'])) {
  $id=$_GET['id'];
$view=$pdo->prepare("SELECT * FROM tbl_bird WHERE id={$_GET['id']}");
$view->execute();
    ...
    <label> <?php
          echo '<img src="admin/photo/bird/'.$display['image'].'" width="150rem"; height="150rem"; alt=" card image cap">';?></label>
...
<!-- fourth row -->
    ...
    <div class="form-group col-md-6">
      <label>Clutch size : <?php echo $display['clutch_size']; ?></label>
    
    </div>
 <!-- fifth row -->
  <div class="form-group col-md-6">
      <label>Nest Construction Method : <?php echo $display['nest_construction_method']; ?></label>
    
    </div>
    <div class="form-group col-md-6">
      <label>Wingspan : <?php echo $display['wingspan']; ?></label>
...
<div class="form-group col-md-6">
     ...
     <label>Ability to fly? : <?php echo $display['fly']; ?></label><br>
