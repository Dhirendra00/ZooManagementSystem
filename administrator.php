...
include 'session.php';
$stmt=$pdo->prepare("SELECT * FROM tbl_administrator");
$stmt->execute();
   ...
   <section style="background-color: rgb(46,70,91);">
    ...
    <div class="container-fluid p-3" >
    	...
    	<div class="items" style="background-color: ivory;">
				<?php
				foreach ($stmt as $row) {?> <a href="administrator_detail.php?id=<?=$row['id']?>">
			<div class="item">
					<?php
					echo '<img src="admin/photo/administrator/'.$row['image'].'" width="150rem"; height="150rem"; alt=" card image cap">';?>
