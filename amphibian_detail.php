...
<span>
  ...
  <li class="nav-item">
    <a class="nav-link text-danger" href="#">Bird</a>
  </li>
  <li class="nav-item">
    <a class="nav-link text-danger" href="#">Mammal</a>
  </li>
   <li class="nav-item">
    <a class="nav-link text-danger" href="#">Reptile</a>
  </li>
   <li class="nav-item">
    <a class="nav-link text-danger" href="#">Amphibian</a>
  </li>
...
<!-- <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 " style="background-color: rgb(23,22,22); opacity: 0.5; border-radius: 5rem;"  > -->
      ...
      <div class="form-row">
        ...
        if (isset($_GET['id'])) {
  $id=$_GET['id'];
$view=$pdo->prepare("SELECT * FROM tbl_fish WHERE id={$_GET['id']}");
$view->execute();
    ...
    <label> <?php
          echo '<img src="admin/photo/amphibian/'.$display['image'].'" width="150rem"; height="150rem"; alt=" card image cap">';?></label>
...
<!-- fourth row -->
 ...
 <!-- fifth row -->
  <div class="form-group col-md-6">
      <label>Average Body Temperatue : <?php echo $display['av_body_temperature']; ?></label>
    
    </div>
 
     <div class="form-group col-md-6">
      <label>Water Type : <?php echo $display['water_type']; ?></label>
     
    </div>

     <div class="form-group col-md-6">
      <label>Colour Variant : <?php echo $display['colour_variant']; ?></label>
