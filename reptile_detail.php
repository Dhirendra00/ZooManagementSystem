...
<!-- <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 " style="background-color: rgb(23,22,22); opacity: 0.5; border-radius: 5rem;"  > -->
      ...
      <div class="form-row">
        ...
        if (isset($_GET['id'])) {
  $id=$_GET['id'];
$view=$pdo->prepare("SELECT * FROM tbl_reptile WHERE id={$_GET['id']}");
$view->execute();
    ...
    <label> <?php
          echo '<img src="admin/photo/reptile/'.$display['image'].'" width="150rem"; height="150rem"; alt=" card image cap">';?></label>
...
<!-- fourth row -->
    ...
    <div class="form-group col-md-6">
      <label>Average No Of Offspring : <?php echo $display['av_no_of_offspring']; ?></label>
    
    </div>
 <!-- fifth row -->

     <div class="form-group col-md-6">
      <label>Reproduction Type : <?php echo $display['reproduction_type']; ?></label>
